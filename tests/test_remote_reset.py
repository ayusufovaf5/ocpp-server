...
@pytest.mark.asyncio
async def test_reset_soft_happy_path_via_rest_and_ws(ocpp_http_server, db_session) -> None:
    charge_point_id = "CP_RESET_SOFT"
    ...
    async with websockets.connect(
        ...
        async with AsyncClient(
            ...
            response = await client.post(
                f"/reset/{charge_point_id}",
                json={"reset_type": "soft"},
            )
